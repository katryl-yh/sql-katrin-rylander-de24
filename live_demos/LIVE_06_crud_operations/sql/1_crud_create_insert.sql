-- DML -- Data Manipulation Language AND DQL - Data Query Language
...
-- Q: HOW to prevent situation where we instert same row several times!
...
-- check the current content of the table
